...
func (gh *GitHubRepo) DownloadVersion(fork, flavor, version, destDir, destFile string) (string, error) {
	filename, err := platforms.DetermineBazelFilename(flavor, version, true)
	if err != nil {
		return "", err
	}
