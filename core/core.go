...
// TODO(fweikert): This file contains all the code that was previously in bazelisk.go. We should split it into multiple smaller files (and maybe even introduce new packages for execution, incompatible stuff etc).
...
// TODO(fweikert): visible for testing. Move the test!
