...
cp bazel-bin/bazelisk-darwin_arm64 bin/bazelisk-darwin-arm64
cp bazel-bin/bazelisk-darwin_universal bin/bazelisk-darwin
cp bazel-bin/bazelisk-linux_amd64 bin/bazelisk-linux-amd64
cp bazel-bin/bazelisk-linux_arm64 bin/bazelisk-linux-arm64
